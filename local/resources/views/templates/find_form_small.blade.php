<div class="main border">
    ...
    <div class="border main_top">
        ...
        <div class="border container_left">
            ...
            <div class="border btn-small" style="float: left"><strong>Быстрый поиск</strong></div>
            <div class="border btn-small" style="float: left"><strong>Подать объявление</strong></div>
            <div class="clear"></div>
